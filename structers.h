...
/**
 * @brief функци¤ для добавления новго сотрудника в хранилище Employees_storage
 ...
 * @param hire_date_y_ год приёма на работу
*/
...
/**
 * @brief функци¤ выводящяя информацию о сотрудниках, стаж которых превышает 10 лет
 * @param storage_ указатель на хранилище структур
*/
